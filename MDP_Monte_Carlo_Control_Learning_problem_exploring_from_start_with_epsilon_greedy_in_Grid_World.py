...
def fill_grid_world_with_random_action_of_states(gridworld_ndarray):
    """
...
@njit
def play_one_episode(n_states_vertical, n_states_horizontal, gridworld_ndarray, rewards_plus_qsa_values_ndarray, win_terminal_state, loose_terminal_state, starting_sate):
    """
    play one episode of the game, update Q(s,a), policy, and sum of returns for every Q(s,a)
    """
    gamma = 0.9
    state_k_coord = starting_sate
    
    action_of_state, gridworld_ndarray = select_action_from_state_by_epsilon_and_coord_of_next_state(n_states_vertical, n_states_horizontal, gridworld_ndarray, state_k_coord, rewards_plus_qsa_values_ndarray)
...
# gridworld_ndarray = fill_grid_world_with_random_action_of_states(gridworld_ndarray)
